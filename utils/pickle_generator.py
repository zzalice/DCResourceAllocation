...
def visualize_phase_uncategorized_ue(file_path: str, mode: str, title: str, gnb: GNodeB, enb: ENodeB,
    ...
    gue_allocated, gue_unallocated = divide_ue(gue_list, assert_throughput=False)
    due_allocated, due_unallocated = divide_ue(due_list, assert_throughput=False)
    eue_allocated, eue_unallocated = divide_ue(eue_list, assert_throughput=False)
