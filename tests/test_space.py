...
@pytest.fixture()
def space_g_0_0_15_7(layer_g_0):
    return Space(layer_g_0, 0, 0, 15, 7)
...
@pytest.fixture()
def space_e_0_0_2_7(layer_e):
    return Space(layer_e, 0, 0, 2, 7)


def test_next_rb(space_g_0_0_15_7, space_e_0_0_2_7):
    assert space_g_0_0_15_7.next_rb(0, 0, Numerology.N2) == (0, 2)
    assert space_g_0_0_15_7.next_rb(0, 6, Numerology.N2) == (4, 0)
    assert space_g_0_0_15_7.next_rb(14, 6, Numerology.N2) is None

    assert space_e_0_0_2_7.next_rb(0, 0, LTEResourceBlock.E) == (0, 4)
    assert space_e_0_0_2_7.next_rb(0, 4, LTEResourceBlock.E) == (1, 0)
    assert space_e_0_0_2_7.next_rb(2, 4, LTEResourceBlock.E) is None

    assert space_g_0_0_15_7.next_rb(14, 6, Numerology.N2) is None
    assert space_g_0_0_15_7.next_rb(15, 7, Numerology.N2) is None
