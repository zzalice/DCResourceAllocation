...
if __name__ == '__main__':
    ...
    line_chart('', 'The number of gNB layer', max_layers, 'System throughput(Mbps)', avg_system_throughput,
               f'src/simulation/data/{file_path}/sys_rate_{str(time)}time')

    with open(f'src/simulation/data/{file_path}/graph_generator_{str(time)}time.P', 'wb') as f:
